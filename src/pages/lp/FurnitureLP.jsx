...
const config = {
  ...
  brands: [
    { name: "カリモク", logo: "https://logo.clearbit.com/karimoku.com" },
    { name: "Fritz Hansen", logo: "https://logo.clearbit.com/fritzhansen.com" },
    { name: "Herman Miller", logo: "https://logo.clearbit.com/hermanmiller.com" },
    { name: "Cassina", logo: "https://logo.clearbit.com/cassina.com" },
    { name: "アクタス", logo: "https://logo.clearbit.com/actus.co.jp" },
    { name: "UNICO", logo: null },
    { name: "無印良品", logo: "https://logo.clearbit.com/muji.com" },
    { name: "IKEA", logo: "https://logo.clearbit.com/ikea.com" },
    { name: "BD Barcelona", logo: "https://logo.clearbit.com/bdbarcelona.com" },
    { name: "Vitra", logo: "https://logo.clearbit.com/vitra.com" },
    { name: "Arflex", logo: "https://logo.clearbit.com/arflex.it" },
    { name: "北欧ヴィンテージ", logo: null },
    { name: "天童木工", logo: null },
    { name: "飛騨産業", logo: null },
    { name: "大川家具", logo: null },
    { name: "Knoll", logo: "https://logo.clearbit.com/knoll.com" },
  ],
  testimonials: [
