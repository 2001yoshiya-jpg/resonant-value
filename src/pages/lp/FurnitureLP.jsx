...
const config = {
  ...
  brands: [
    { name: "カリモク", domain: "karimoku.com" },
    { name: "Fritz Hansen", domain: "fritzhansen.com" },
    { name: "Herman Miller", domain: "hermanmiller.com" },
    { name: "Cassina", domain: "cassina.com" },
    { name: "アクタス", domain: "actus.co.jp" },
    { name: "UNICO", domain: "unico-fan.co.jp" },
    { name: "無印良品", domain: "muji.com" },
    { name: "IKEA", domain: "ikea.com" },
    { name: "Vitra", domain: "vitra.com" },
    { name: "Arflex", domain: "arflex.it" },
    { name: "Knoll", domain: "knoll.com" },
    { name: "Cassina IXC", domain: "cassinaics.co.jp" },
    { name: "天童木工", domain: "tendo-mokko.co.jp" },
    { name: "飛騨産業", domain: "hidasan.com" },
    { name: "大川家具", domain: "okawa-furniture.or.jp" },
    { name: "B&B Italia", domain: "bebitalia.com" },
  ],
  testimonials: [
