...
const config = {
  ...
  brands: [
    ...
    { name: "HARRY WINSTON", domain: "harrywinston.com" },
    { name: "MIKIMOTO", domain: "mikimoto.com" },
    { name: "VAN CLEEF", domain: "vancleefarpels.com" },
    { name: "GRAFF", domain: "graffdiamonds.com" },
    { name: "CHAUMET", domain: "chaumet.com" },
    { name: "DAMIANI", domain: "damiani.com" },
    { name: "PIAGET", domain: "piaget.com" },
    { name: "CHOPARD", domain: "chopard.com" },
    { name: "DE BEERS", domain: "debeers.com" },
    { name: "TASAKI", domain: "tasaki.co.jp" },
    { name: "AGETE", domain: "agete.com" },
    { name: "4℃", domain: "4-℃.jp" },
    { name: "AHKAH", domain: "ahkah.com" },
  ],
  testimonials: [
