...
const config = {
  ...
  brands: [
    { name: "MEISSEN", logo: null },
    { name: "WEDGWOOD", logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/67/Wedgwood_logo.svg/320px-Wedgwood_logo.svg.png" },
    { name: "LIMOGES", logo: null },
    { name: "ROYAL COPENHAGEN", logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Royal_Copenhagen_logo.svg/320px-Royal_Copenhagen_logo.svg.png" },
    { name: "NORITAKE", logo: null },
    { name: "HERMÈS", logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5b/Hermes_logo.svg/320px-Hermes_logo.svg.png" },
    { name: "VILLEROY & BOCH", logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/32/Villeroy_%26_Boch_logo.svg/320px-Villeroy_%26_Boch_logo.svg.png" },
    { name: "BERNARDAUD", logo: null },
    { name: "CHRISTOFLE", logo: null },
    { name: "BACCARAT", logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8f/Baccarat_logo.svg/320px-Baccarat_logo.svg.png" },
    { name: "WATERFORD", logo: null },
    { name: "SPODE", logo: null },
    { name: "MINTON", logo: null },
    { name: "ROYAL CROWN DERBY", logo: null },
    { name: "有田焼", logo: null },
    { name: "清水焼", logo: null },
  ],
  testimonials: [
