...
const config = {
  ...
  brands: ["MEISSEN", "WEDGWOOD", "LIMOGES", "ROYAL COPENHAGEN", "NORITAKE", "HERMES", "VILLEROY&BOCH", "BERNARDAUD", "CHRISTOFLE", "BACCARAT", "WATERFORD", "SPODE", "MINTON", "ROYAL CROWN DERBY", "有田焼", "清水焼"],
  testimonials: [
