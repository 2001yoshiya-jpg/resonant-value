...
const config = {
  ...
  brands: [
    ...
    { name: "LEICA", domain: "leica-camera.com" },
    { name: "OLYMPUS", domain: "olympus.com" },
    { name: "PANASONIC", domain: "panasonic.com" },
    { name: "PENTAX", domain: "ricoh-imaging.com" },
    { name: "SIGMA", domain: "sigma-global.com" },
    { name: "TAMRON", domain: "tamron.com" },
    { name: "TOKINA", domain: "tokinalens.com" },
    { name: "ZEISS", domain: "zeiss.com" },
    { name: "VOIGTLANDER", domain: "cosina.co.jp" },
    { name: "HASSELBLAD", domain: "hasselblad.com" },
    { name: "PHASE ONE", domain: "phaseone.com" },
    { name: "MAMIYA", domain: "mamiya.com" },
  ],
  testimonials: [
