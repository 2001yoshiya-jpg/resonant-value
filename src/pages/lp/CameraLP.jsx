...
const config = {
  ...
  brands: [
    ...
    { name: "FUJIFILM", logo: "https://logo.clearbit.com/fujifilm.com" },
    { name: "LEICA", logo: "https://logo.clearbit.com/leica-camera.com" },
    { name: "OLYMPUS", logo: "https://logo.clearbit.com/olympus.com" },
    { name: "PANASONIC", logo: "https://logo.clearbit.com/panasonic.com" },
    { name: "PENTAX", logo: "https://logo.clearbit.com/ricoh-imaging.com" },
    { name: "SIGMA", logo: "https://logo.clearbit.com/sigma-global.com" },
    { name: "TAMRON", logo: "https://logo.clearbit.com/tamron.com" },
    { name: "TOKINA", logo: null },
    { name: "ZEISS", logo: "https://logo.clearbit.com/zeiss.com" },
    { name: "VOIGTLANDER", logo: null },
    { name: "HASSELBLAD", logo: "https://logo.clearbit.com/hasselblad.com" },
    { name: "PHASE ONE", logo: "https://logo.clearbit.com/phaseone.com" },
