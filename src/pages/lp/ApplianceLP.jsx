...
const config = {
  ...
  brands: [
    ...
    { name: "SHARP", domain: "sharp.co.jp" },
    { name: "TOSHIBA", domain: "toshiba.com" },
    { name: "HITACHI", domain: "hitachi.com" },
    { name: "MITSUBISHI", domain: "mitsubishi-electric.com" },
    { name: "DYSON", domain: "dyson.com" },
    { name: "BALMUDA", domain: "balmuda.com" },
    ...
    { name: "DELONGHI", domain: "delonghi.com" },
    { name: "NESPRESSO", domain: "nespresso.com" },
  ],
  testimonials: [
