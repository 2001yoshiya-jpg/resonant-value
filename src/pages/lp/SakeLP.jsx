...
const config = {
  ...
  brands: [
    { name: "山崎", domain: "suntory.com" },
    { name: "響", domain: "suntory.com" },
    { name: "白州", domain: "suntory.com" },
    { name: "竹鶴", domain: "nikka.com" },
    { name: "余市", domain: "nikka.com" },
    { name: "知多", domain: "suntory.com" },
    { name: "マッカラン", domain: "themacallan.com" },
    { name: "バランタイン", domain: "ballantines.com" },
    { name: "シバスリーガル", domain: "chivas.com" },
    { name: "ジョニーウォーカー", domain: "johnniewalker.com" },
    { name: "ドンペリニヨン", domain: "domperignon.com" },
    { name: "モエ", domain: "moet.com" },
    { name: "ペトリュス", domain: "petrus.fr" },
    { name: "ロマネコンティ", domain: "romanee-conti.fr" },
    { name: "シャトーマルゴー", domain: "chateau-margaux.com" },
    { name: "オーパスワン", domain: "opusonewinery.com" },
  ],
  testimonials: [
