...
const config = {
  ...
  brands: [
    { name: "山崎", logo: "https://logo.clearbit.com/suntory.com" },
    { name: "響", logo: "https://logo.clearbit.com/suntory.com" },
    { name: "白州", logo: "https://logo.clearbit.com/suntory.com" },
    { name: "竹鶴", logo: "https://logo.clearbit.com/nikka.com" },
    { name: "余市", logo: "https://logo.clearbit.com/nikka.com" },
    { name: "知多", logo: "https://logo.clearbit.com/suntory.com" },
    { name: "マッカラン", logo: "https://logo.clearbit.com/themacallan.com" },
    { name: "バランタイン", logo: "https://logo.clearbit.com/ballantines.com" },
    { name: "シバスリーガル", logo: "https://logo.clearbit.com/chivas.com" },
    { name: "ジョニーウォーカー", logo: "https://logo.clearbit.com/johnniewalker.com" },
    { name: "ドンペリニヨン", logo: "https://logo.clearbit.com/domperignon.com" },
    { name: "モエ", logo: "https://logo.clearbit.com/moet.com" },
    { name: "ペトリュス", logo: null },
    { name: "ロマネコンティ", logo: null },
    { name: "シャトーマルゴー", logo: null },
    { name: "オーパスワン", logo: "https://logo.clearbit.com/opusonewinery.com" },
  ],
  testimonials: [
