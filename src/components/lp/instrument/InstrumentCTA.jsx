      ...
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-12">
          ...
          <h2 className="font-jp text-2xl md:text-3xl font-black text-white">
            「この楽器、売れる？」だけでも<span className="text-white">大丈夫です。</span>
          </h2>
        </div>
            ...
            {submitted ? (
              ...
              <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); setSubmitted(true); }}>
                ...
                <div className="space-y-1">
                  <Label className="font-jp text-xs">お名前 <span className="text-red-500">*</span></Label>
                  <Input className="h-10 font-jp text-sm" placeholder="山田 太郎" required />
                </div>
                <div className="space-y-1">
                  <Label className="font-jp text-xs">電話番号 <span className="text-red-500">*</span></Label>
                  <Input className="h-10 font-jp text-sm" placeholder="090-XXXX-XXXX" required />
                </div>
                <div className="space-y-1">
                  <Label className="font-jp text-xs">メールアドレス <span className="text-red-500">*</span></Label>
                  <Input type="email" className="h-10 font-jp text-sm" placeholder="example@mail.com" required />
                </div>
                <div className="space-y-1">
                  <Label className="font-jp text-xs">査定希望品</Label>
                  <Input className="h-10 font-jp text-sm" placeholder="例：ヤマハ アコースティックギター" />
                </div>
                <div className="space-y-1">
