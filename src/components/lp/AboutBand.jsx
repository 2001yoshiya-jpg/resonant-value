        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          >
            ...
            <h2 className="font-jp text-2xl md:text-3xl font-black text-navy leading-snug mb-4">
              ご自宅の不用な楽器<br />
              <span className="text-amber">楽器買取センター</span>が出張買取
            </h2>
            <p className="text-muted-foreground font-jp text-sm leading-relaxed mb-6">
              「これ売れるかな？」「片付けたいけど重くて運べない」<br />
              そんなお品物も、楽器買取センターがご自宅までお伺いします。
            </p>
          ...
          >
            <div className="relative rounded-xl overflow-hidden shadow-xl">
              <img
                src="https://images.unsplash.com/photo-1598488035139-bdbb2231ce04?w=800&q=85"
                alt="楽器買取スタッフ"
