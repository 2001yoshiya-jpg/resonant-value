        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 mb-8 pb-8 border-b border-white/10">
          <div>
            <div className="flex items-center mb-2">
              <img src="https://media.base44.com/images/public/6a07fe0d9aa87ec73e08277b/6cdcdf294_image.png" alt="くらの助" className="h-8 w-auto object-contain brightness-0 invert" />
            </div>
